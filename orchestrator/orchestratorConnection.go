...
type OrchestratorConnection interface {
	Connect() error
	Orchestration(requestedService models.ServiceDefinition, requesterSystem models.SystemDefinition, orchestrationFlags map[string]bool, requesterCloud models.RequesterCloud) (*models.OrchestrationResponse, error)
}
